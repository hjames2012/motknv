...
function UnityProgress(gameInstance, progress) {
    ...
    gameInstance.textProgress.innerHTML = 'Loading - ' + Math.floor(progress * 100) + '%' + ' <img src="/gif/gears.gif" class="spinner" />';

    if(progress>= 0.9 && progress<1)
    {
        gameInstance.textProgress.innerHTML = '100% - Running, Wait..' +' <img src="/gif/gears.gif" class="spinner" />';
    ...
    if (progress == 1) {
        gameInstance.textProgress.innerHTML = 'Running, Please Wait.. <img src="/gif/gears.gif" class="spinner" />';
        gameInstance.progress.style.display = 'none';
    }
...
window.Game = (function() {
    ...
    // canvas does not exist on page load
    if (canvas) {
